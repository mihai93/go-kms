...
import (
	...
	"github.com/forku/go-skeleton/restapi/operations"
	"github.com/forku/go-skeleton/restapi/operations/todos"
)

//go:generate swagger generate server --target ../../go-skeleton --name TodoList --spec ../swagger.yml
